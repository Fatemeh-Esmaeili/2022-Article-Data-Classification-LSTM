...
tablePath = "Result\2022-07-25-LSTM-35merAdenosine\";
...
Save Tables
accuracyTableName= strcat(tablePath, 'AccuracyReal-zscoreAugment-1seg1seqUniLSTM3NetsHiddenUnEpoch50.csv');
writetable(accuracyTableReal, accuracyTableName);

% microF1TableName= strcat(tablePath, 'microF1Real-zscoreAugment-1seg1seqUniLSTM3NetsHiddenUnEpoch50.csv');
% writetable(microF1TableReal, microF1TableName);

macroF1TableName= strcat(tablePath, 'macroF1Real-zscoreAugment-1seg1seqUniLSTM3NetsHiddenUnEpoch50.csv');
writetable(macroF1TableReal, macroF1TableName);

accuracyTableName= strcat(tablePath, 'AccuracyNet-zscoreAugment-1seg1seqUniLSTM3NetsHiddenUnEpoch50.csv');
writetable(accuracyTableNet, accuracyTableName);

% microF1TableName= strcat(tablePath, 'microF1Net-zscoreAugment-1seg1seqUniLSTM3NetsHiddenUnEpoch50.csv');
% writetable(microF1TableNet, microF1TableName);

macroF1TableName= strcat(tablePath, 'macroF1Net-zscoreAugment-1seg1seqUniLSTM3NetsHiddenUnEpoch50.csv');
